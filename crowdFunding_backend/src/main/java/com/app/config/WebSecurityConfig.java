...
public class WebSecurityConfig  {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.antMatchers("/organization/getAllFunds").permitAll()
		.antMatchers("/customer/checkContributionEligibility").permitAll()
		.antMatchers("/customer/getFundsByUser/**").permitAll()
		.antMatchers("/organization/getContributionsByFundId/**").permitAll()
